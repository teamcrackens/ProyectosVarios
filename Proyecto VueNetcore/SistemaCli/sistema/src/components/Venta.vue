            ...
            >
                <template slot="items" slot-scope="props">
                    <td class="justify-center layout px-0">
                        ...
                        small
                        class="mr-2"
                        @click="mostarComprobante(props.item)"
                        >
                        print
                        </v-icon>
            ...
            <v-container  grid-list-sm class="pa-4 white" v-if="verNuevo" >
                <v-layout row wrap>
                    ...
                    <v-flex xs12 sm2 md2 lg2 xl2>
                        <v-btn @click="mostrarArticulos()" fab dark color="teal">
    ...
    export default {
        ...
        methods:{
            ...
            listarArticulo(){
                ...
                let header = {"Authorization" : "Bearer " + this.$store.state.token};
                let configuracion = {headers : header};
                axios.get('api/Articulos/ListarVenta/'+ this.texto,configuracion).then(function(response){
                    //console.log(response);
            ...
            validar(){
                ...
                if (!this.num_comprobante){
                    this.validaMensaje.push("Ingrese el nro. del comprobante.");
                }
                if (!this.impuesto || this.impuesto < 0){
                    this.validaMensaje.push("Ingrese un impuesto valido (mayor a 0).");
                }
